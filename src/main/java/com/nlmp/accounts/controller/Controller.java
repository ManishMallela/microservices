...
import com.nlmp.accounts.dto.ResponseDto;
...
import static com.nlmp.accounts.constants.AccountsConstants.*;
...
class Controller {
    ...
    public ResponseEntity<ResponseDto> updateAccountDetails(@Valid @RequestBody CustomerDto customerDto){
        ...
        if(isUpdated){
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new ResponseDto(STATUS_417,MESSAGE_201));
        }
    }
